...
import 'package:ashfood/controllers/new_menu_controller.dart';
                        ...
                        Center(
                          child: Obx(
                            () => CircularPercentIndicator(
                              ...
                              animation: true,
                              percent:
                                  controller.currentUploadPercentage.value *
                                      0.01,
                              center: Obx(
                                () => Text(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                      ...
                      setState(() {
                        ...
                        controller.description.value.selection =
                            TextSelection.collapsed(
                                offset:
                                    controller.description.value.text.length);
                      });
                    },
              ...
              Obx(
                () => AnimatedCrossFade(
                  firstChild: Padding(
                    ...
                    child: Text(
                      controller.description.value.text.isEmpty
                          ...
                          : "Description must be at least 10 characters".tr,
                  ...
                  crossFadeState: controller.validationError.value &&
                          (controller.description.value.text.isEmpty ||
                              controller.description.value.text.length < 10)
              ...
              Obx(
                () => Text("Upload at least two images of the menu".tr,
                    style: TextStyle(
                        fontSize: 16,
